...
fun <T> IrType.getPrimitiveOrUnsignedType(byIdSignature: Map<IdSignature.CommonSignature, T>, byShortName: Map<Name, T>): T? {
...
private val idSignatureToUnsignedType = hashMapOf(
    IdSignatureValues.uByte to UnsignedType.UBYTE,
    IdSignatureValues.uShort to UnsignedType.USHORT,
    IdSignatureValues.uInt to UnsignedType.UINT,
    IdSignatureValues.uLong to UnsignedType.ULONG,
)
